...
// Generated by com.ibm.jzos.recordgen.cobol.RecordClassGenerator on Thu Feb 18 20:14:34 GMT+02:00 2016
...
public class CommareaWrapper {
	...
	public CommareaWrapper (byte[] buffer, int bufOffset) {
	...
	public int getBinaryDigit() {
		if (binaryDigit == null) {
			binaryDigit = new Integer(BINARY_DIGIT.getInt(_byteBuffer, _byteBufferOffset));
		}
	...
	public void setBinaryDigit(int binaryDigit) {
		...
		BINARY_DIGIT.putInt(binaryDigit, _byteBuffer, _byteBufferOffset);
		this.binaryDigit = new Integer(binaryDigit);
	}

	public String getCharacterString() {
		if (characterString == null) {
			characterString = CHARACTER_STRING.getString(_byteBuffer, _byteBufferOffset);
		}
	...
	public void setCharacterString(String characterString) {
		...
		CHARACTER_STRING.putString(characterString, _byteBuffer, _byteBufferOffset);
		this.characterString = characterString;
	}

	public long getNumericString() {
		if (numericString == null) {
			numericString = new Long(NUMERIC_STRING.getLong(_byteBuffer, _byteBufferOffset));
		}
	...
	public void setNumericString(long numericString) {
		...
		NUMERIC_STRING.putLong(numericString, _byteBuffer, _byteBufferOffset);
		this.numericString = new Long(numericString);
	}

	public long getPackedDigit() {
		if (packedDigit == null) {
			packedDigit = new Long(PACKED_DIGIT.getLong(_byteBuffer, _byteBufferOffset));
		}
	...
	public void setPackedDigit(long packedDigit) {
		...
		PACKED_DIGIT.putLong(packedDigit, _byteBuffer, _byteBufferOffset);
		this.packedDigit = new Long(packedDigit);
	}

	public BigDecimal getPackedDigitWithComma() {
		if (packedDigitWithComma == null) {
			packedDigitWithComma = PACKED_DIGIT_WITH_COMMA.getBigDecimal(_byteBuffer, _byteBufferOffset);
		}
	...
	public void setPackedDigitWithComma(BigDecimal packedDigitWithComma) {
		...
		PACKED_DIGIT_WITH_COMMA.putBigDecimal(packedDigitWithComma, _byteBuffer, _byteBufferOffset);
		this.packedDigitWithComma = packedDigitWithComma;
	}

	public long getSignedPacked() {
		if (signedPacked == null) {
			signedPacked = new Long(SIGNED_PACKED.getLong(_byteBuffer, _byteBufferOffset));
		}
	...
	public void setSignedPacked(long signedPacked) {
		...
		SIGNED_PACKED.putLong(signedPacked, _byteBuffer, _byteBufferOffset);
		this.signedPacked = new Long(signedPacked);
	}

	public String getBool() {
		if (bool == null) {
			bool = BOOL.getString(_byteBuffer, _byteBufferOffset);
		}
		return bool;
	}
	...
	public void setBool(String bool) {
		...
		BOOL.putString(bool, _byteBuffer, _byteBufferOffset);
		this.bool = bool;
	}

	public int getResultCode() {
		if (resultCode == null) {
			resultCode = new Integer(RESULT_CODE.getInt(_byteBuffer, _byteBufferOffset));
		}
	...
	public void setResultCode(int resultCode) {
		...
		RESULT_CODE.putInt(resultCode, _byteBuffer, _byteBufferOffset);
		this.resultCode = new Integer(resultCode);
	}

	public String getResultText() {
		if (resultText == null) {
			resultText = RESULT_TEXT.getString(_byteBuffer, _byteBufferOffset);
		}
		return resultText;
	}
	...
	public void setResultText(String resultText) {
		...
		RESULT_TEXT.putString(resultText, _byteBuffer, _byteBufferOffset);
